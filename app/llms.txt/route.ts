...
- Seasons are identified by id (e.g. \`2025-2026\`, \`2024-2025\`, \`2024-summer\`). The current season is \`2025-2026\`. Pass \`?season=all\` for all-time stats where supported.
...
- To answer "what's the score of {team}'s last game", call \`/api/bash?season=2025-2026\` and filter the \`games\` array — it's already sorted by date.
